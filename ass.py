print('here are the available bank ussd code:')
print('Access: *901#\nUBA: *919#\nFCMB: *329#\n')
def menu ():
	...
	assure= eval(input('Do you want to send',amount,'to',trans,'\n 1. Yes \n 2. No'))
	if (assure==1):
				...
				exit()
					...
					print('wrong input')
						...
						if (airtime==1):
							...
							assure=eval(input('do you want to buy', amount, 'naira worth of airtime for', number,'?\n1.Yes\n2.No'))								
							if (assure==1):
								print('Transaction Successful')
								top=eval(input('Enter 1 to return to menu\nEnter 2 to end'))
								if (top==1):
